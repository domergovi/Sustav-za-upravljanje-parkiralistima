 ...
 */
package org.foi.nwtis.domergovi.ejb.eb;
...
@NamedQueries({
    ...
    , @NamedQuery(name = "Dnevnik.findBySadrzaj", query = "SELECT d FROM Dnevnik d WHERE d.sadrzaj = :sadrzaj")
...
public class Dnevnik implements Serializable {
    ...
    public Dnevnik(Integer id, String korisnik, String url, String ipadresa, int trajanje, String sadrzaj, String vrsta) {
        this.id = id;
    ...
    public String toString() {
        return "org.foi.nwtis.domergovi.ejb.eb.Dnevnik[ id=" + id + " ]";
    }
